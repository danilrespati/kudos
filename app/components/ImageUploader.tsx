...
export const ImageUploader = ({ onChange, imageUrl }: props) => {
  ...
  return (
    <div
      ...
      } group rounded-full relative w-24 h-24 mx-auto flex justify-center items-center bg-gray-400 transition duration-300 ease-in-out hover:bg-gray-500 cursor-pointer`}
      style={{
